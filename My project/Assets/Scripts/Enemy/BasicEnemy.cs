...
public class BasicEnemy : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        if(levelManager.playerObject.GetComponent<CharacterController2D>().state != PlayerState.CANTMOVE && !levelManager.playerObject.GetComponent<CharacterController2D>().isShopping)
        {
